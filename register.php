...
if ($_SERVER['REQUEST_METHOD'] === "POST") 
{
   ...
   if (!empty($username) && !empty($password)) 
   {
    ...
    $query = "Insert into users (fullname,email,password) Values ('$username','$email','$password')";
   ...
   {
    echo "Please Filled all the Requied Fields!";
...
<head>
    ...
    <title>Register Page - WindEx </title>
            ...
            <div class="content-body">
                <div class="auth-wrapper auth-cover">
                    <div class="auth-inner row m-0">
                        <!-- Brand logo--><a class="brand-logo" href="register.php">
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h2 class="card-title fw-bold mb-1">Welcome to Windex New Adventure starts here</h2>
                                ...
                                <form class="auth-register-form mt-2" action="register.php" method="POST">
                                    ...
                                    <button class="btn btn-primary w-100" name="submit" type="submit" tabindex="5">Sign
                                        up</button>
                                </form>
                                <p class="text-center mt-2"><span>Already have an account?</span><a
                                        href="login.php"><span>&nbsp;Sign in instead</span></a></p>
